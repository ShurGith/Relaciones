        ...
        <div class="border-b border-gray-200 py-4">
            ...
            <div class="flex items-center  gap-3 mt-4">
                <a href="{{ route('comment.edit', $comment->id) }}">
                    <svg aria-hidden="true" fill="#0000ff" height="24" id="Pencil-Square--Streamline-Heroicons" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                ...
                <button type="button" class="btnAcc" onclick="(this.nextElementSibling.classList.toggle('hidden'))">
                    ...
                    <svg aria-hidden="true" fill="#ff0000" height="24" id="Trash--Streamline-Heroicons" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                ...
                <form action="{{ route('comment.destroy', $comment->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button class="bg-red-500 text-white text-xs px-4 py-2 rounded-md " type="submit">Confirmar Eliminado</button>
